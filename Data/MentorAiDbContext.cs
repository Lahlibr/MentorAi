// MentorAi_backd/Data/MentorAiDbContext.cs
...
using MentorAi_backd.Models.Enum; // For enums in seeding (if any remain here)
...
namespace MentorAi_backd.Data
{
    public class MentorAiDbContext : DbContext
    {
        ...
        public DbSet<Models.Entity.UserEntity.Module> Modules { get; set; } = default!; // Simplified DbSet declaration
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Models.Entity.UserEntity.Module>().HasData(
                new Models.Entity.UserEntity.Module { Id = 1, RoadmapId = 1, Title = "Introduction to C#", Description = "Basic syntax and variables.", OrderInRoadmap = 1, CreatedAt = DateTime.UtcNow, LastUpdatedAt = DateTime.UtcNow },
                new Models.Entity.UserEntity.Module { Id = 2, RoadmapId = 1, Title = "Control Flow", Description = "If statements and loops.", OrderInRoadmap = 2, CreatedAt = DateTime.UtcNow, LastUpdatedAt = DateTime.UtcNow }
            );
